...
const Bande1 = () => {
    ...
    return (
        <BandeLayout
            ...
            minitext={<p style={{ fontSize: 8, fontFamily: 'Muli', textAlign: 'center', color: '#757575' }}>Essayez fleeti gratuitement pendant 30 jours, aucune <br />carte de crédit n’est requise.</p>}
            showDemoBtn
        >
